    ...
    return(
        <div>
            <div className="flex flex-col w-10/12 ml-24 place-items-center bg-white mt-10 ">
                <h1 className="mt-16 font-bold underline text-center text-3xl">Honda City 2024 Price in Pakistan, Images, Reviews & <br /> Specs</h1>
                <div className="mt-10">
                    <img className="w-12/12 h-80 mb-6" src="https://th.bing.com/th/id/OIP.KKBj7EW2mKuUY351ZkJ1hgAAAA?rs=1&pid=ImgDetMain" alt="City-car" />
                </div>
                <div className="flex space-x-10 mt-10 mb-8">
                ...
                <div>
                    <h3 className="mt-5 mb-10 font-bold text-xl underline text-center ">Vehicle Description</h3>
